...
import { BookOpen, Brain, Sparkles, Star, BarChart3, CheckCircle2, FileText, PieChart, Users, BookA, BookText } from "lucide-react";
      ...
      <div className="relative max-w-full mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="relative py-6 md:py-12 bg-[#FAF8FF] -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 px-4 sm:px-6 md:px-8 lg:px-12 mt-10 md:mt-0">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
            {/* Left: Content */}
            <div>
              <span className="inline-block bg-[#7C3AED26] text-[#7C3AED] text-[11px] sm:text-[12px] md:text-[13px] font-semibold px-4 py-1.5 rounded-full mb-4 sm:mb-6 uppercase tracking-wider">
                Our Inspiration
              </span>
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[12px] bg-[#7C3AED26] text-purple-600 flex items-center justify-center shrink-0">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="xl:col-span-7">
                <span className="inline-block bg-[#7C3AED26] text-[#7C3AED] text-[11px] sm:text-[12px] md:text-[13px] font-semibold px-4 py-1.5 rounded-full mb-4 sm:mb-6">
                ...
                <div className="space-y-3 sm:space-y-4 max-w-xl">
                  {[
                    { icon: <BookText className="w-6 h-6" />, text: "Add words from homework, books, or topics you're exploring together for personalized learning." },
                    { icon: <BarChart3 className="w-6 h-6" />, text: "Track progress across different skill areas with clear visual dashboards" },
                    { icon: <CheckCircle2 className="w-6 h-6" />, text: "Identify where a child is improving and where additional support is needed" }
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-[16px] border border-[#7C3AED26] shadow-sm bg-white hover:border-purple-200 transition-colors">
                      <div className="w-8 h-8 rounded-lg bg-[#7C3AED26] text-purple-600 flex items-center justify-center shrink-0">
                        {item.icon}
                      </div>
              ...
              <div className="xl:col-span-5  relative">
                ...
                <div className="text-center px-2">
                  <span className="inline-block bg-[#7C3AED26] text-[#7C3AED] text-[12px] font-semibold px-4 py-1 rounded-full mb-2">
                    Coming Soon
                  </span>

                  <h3 className="text-[26px] sm:text-[32px] md:text-[34px] font-bold text-[#1A0533] font-syne leading-tight">
                    An <span className="text-[#7C3AED]">Intelligent <br /> Assistant</span> Layer
                  </h3>
        ...
        <div className="relative py-2 md:py-8 bg-white">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-12 text-center">
            ...
            <h2 className="text-[22px] sm:text-[28px] md:text-[32px] lg:text-[40px] font-bold text-[#1A0533] font-syne leading-[1.1] mb-4 sm:mb-6 max-w-5xl mx-auto tracking-tight">
            ...
            <div className="max-w-lg mx-auto mb-10">
              <div className="bg-white rounded-[24px] sm:rounded-[32px] md:rounded-[48px] shadow-[0_30px_70px_rgba(0,0,0,0.08)] border border-gray-50 p-3 sm:p-4 md:p-6">
                <div className="relative w-full aspect-[5/4] overflow-hidden rounded-[18px] sm:rounded-[24px]">
                  <Image
        ...
        <div className="relative py-10 md:py-16 bg-[#FAF8FF] -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 px-4 sm:px-6 md:px-8 lg:px-12 overflow-hidden">
          <div className="max-w-[1200px] mx-auto text-center">
            ...
            <p className="text-gray-500 text-[13px] sm:text-[14px] md:text-[16px] leading-relaxed max-w-3xl mx-auto mb-6 md:mb-8 px-2">
          ...
          <div className="relative max-w-[1200px] mx-auto text-center z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#F3E8FF] text-[#7C3AED] flex items-center justify-center mb-6 sm:mb-8">
                    {item.icon}
                  </div>
