      ...
      <div className="max-w-[1440px] mx-auto flex items-center justify-between px-4 md:px-12 xl:px-[100px] py-2 md:py-4">
        ...
        <div className="hidden lg:flex items-center gap-8 xl:gap-[58px] text-[15px] xl:text-[16px] text-black/80 font-poppins">
          <a
            ...
            className="font-medium hover:text-[#7C3AED] transition-colors cursor-pointer"
          >
            Features
          </a>
          <a
        ...
        <div className="hidden lg:flex items-center gap-4 xl:gap-[20px] font-poppins">
          <a
            href={getHref("pricing")}
            className="rounded-[8px] bg-white border border-black/10 hover:border-black flex items-center justify-center px-4 xl:px-[16px] py-2 xl:py-[8px] transition-all"
          >
            <span className="font-medium text-[15px]">Try for Free</span>
          </a>
          <a
            href="/login"
            className="rounded-[8px] bg-[#7c3aed] text-white hover:bg-[#6d28d9] flex items-center justify-center px-4 xl:px-[16px] py-2 xl:py-[8px] shadow-lg shadow-purple-500/20 transition-all"
          >
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-white border-b border-purple-100 shadow-2xl animate-fade-in py-6 px-4 flex flex-col gap-6 items-center text-center">
          ...
          <div className="flex flex-col gap-3 w-full max-w-[280px]">
            <a
              href="/signup"
              className="w-full rounded-[8px] bg-white border border-black py-3 font-medium flex items-center justify-center"
            >
              Try for Free
            </a>
            <a
              href="/login"
              className="w-full rounded-[8px] bg-[#7c3aed] text-white py-3 font-medium shadow-lg shadow-purple-500/20 flex items-center justify-center"
            >
              Parents Portal
            </a>
          </div>
